...
export default function Home() {
  return (
    <>
      <RainBackground />
      <main className="relative-10 z-2 flex flex-col items-center max-w-7xl mx-auto mb-[72px]">
        <section id="introducing" className="flex flex-col px-4">
          <h1 className="mt-[86px] text-[24px]">
        ...
        <section id="product-types" className="mt-[42px] px-4">
          <h2 className="text-center">
            What kind of products have I worked on?
          </h2>
        ...
        <section id="about-me" className="w-full mt-[86px] px-4">
          ...
          <p className="mt-2 font-extralight text-justify hyphens-auto">
            ...
            implementing new features, always adhering to industry standards and
            seeking innovation efficiently, basing decisions on test results and
            metric analysis.
          </p>
          <p className="mt-2 font-extralight text-justify hyphens-auto">
            ...
            building APIs and other services using PHP and Node.js, with
            libraries like ExpressJS and NestJS.
          </p>
          <p className="mt-2 font-extralight text-justify hyphens-auto">
            ...
            factor, I leverage Figma for UI/UX tasks and React Native for mobile
            development.
          </p>
        </section>
      </main>
